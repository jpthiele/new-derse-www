---
title: "Code of Conduct for deRSE"
groupByYear: false
showDate: false
...
- Do not use the community communication channels to advertise products or services associated with your organisation. This means, do not use the communication channels for sales.
- Do not directly approach members about products or services unless invited by a member to discuss them.
- Sharing of events and training opportunities is encouraged, however any events should be promoted in the #events room and should be of specific interest to the RSE community (ideally organised with RSE involvement).
- Do not advertise corporate led communities and or certification schemes.
